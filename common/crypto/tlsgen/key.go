...
func newCertKeyPair(isCA bool, isServer bool, certSigner crypto.Signer, parent *sm2.Certificate, hosts ...string) (*CertKeyPair, error) {
	...
	if block == nil { // Never comes unless sm2 or pem has bug
