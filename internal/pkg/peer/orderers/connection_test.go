...
var _ = Describe("Connection", func() {
	var (
		...
		org1CertPool     *sm2.CertPool
		org2CertPool     *sm2.CertPool
		overrideCertPool *sm2.CertPool
	...
	When("an update change's an org's TLS CA", func() {
		...
		It("creates a new set of orderer endpoints", func() {
			newOrg1CertPool := sm2.NewCertPool()
